...
function Server(compiler, options) {
    ...
    Verbose("BEFORE> options.https",options.https);
	if(options.https) {
		// for keep supporting CLI parameters
		if(typeof options.https === "boolean") {
            Verbose("AFTER> typeof options.https === boolean",typeof options.https === "boolean");
			options.https = {
				key: options.key,
				cert: options.cert,
				ca: options.ca,
        ...
        Verbose("BEFORE> !options.https.spdy",!options.https.spdy);
		if(!options.https.spdy) {
			options.https.spdy = {
				protocols: ["h2", "http/1.1"]
			};
            Verbose("AFTER> options.https.spdy",options.https.spdy);
		}
